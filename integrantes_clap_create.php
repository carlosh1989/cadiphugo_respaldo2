      ...
      <div role="tabpanel" class="tab-pane fade in active" id="jefe">
        ...
        <form action="integrantes_clap_guardar.php" method="GET">
          ...
          <div class="form-group form-group-lg">            
            ...
            <br>
            <br>
            <input style="width: 100%;" name="cedula" type="number" placeholder="Cedula del Integrante">
            <br>
            <br>
            <input style="width: 100%;" name="nombre_a" type="text" placeholder="Nombres y Apellidos del Integrante" onChange="javascript:this.value=this.value.toUpperCase();">
            <br>
            <br>
            ...
            <br>
            <br>
            <input style="width: 100%;" name="rif_b" type="number" placeholder="RIF de la Bodega">
            <br>
            <br>
            <input style="width: 100%;" name="razon_social" type="text" placeholder="Nombre de la Bodega (RAZÓN SOCIAL)" onChange="javascript:this.value=this.value.toUpperCase();">
          </div>
        ...
        <br>
        <br>
        <input style="width: 100%;" name="cedula_r" type="number" placeholder="Cedula del Bodeguero">
        <br>
        <br>
        <input style="width: 100%;" name="responsable" type="text" placeholder="Nombres y Apellidos del Bodeguero" onChange="javascript:this.value=this.value.toUpperCase();">
        <br>
        <br>
        <input style="width: 100%;" name="telefono_r" type="number" placeholder="Teléfono del Bodeguero">
        <hr>
